...
public class SupportRequirementNonApprovedViewImpl  extends Panel implements SupportRequirementNonApprovedView, ClickListener{
/*
 ...
 */
	...
	public void init() {
		...
		buttonGo=new Button("Ke Halaman Persetujuan Rencana Kebutuhan");
	...
	public void setListener(SupportRequirementNonApprovedListener listener) {
