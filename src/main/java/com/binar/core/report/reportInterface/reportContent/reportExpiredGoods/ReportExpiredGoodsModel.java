...
public class ReportExpiredGoodsModel extends Label{
	...
	String generateQuantity(List<DeletedGoods> data){
		int x=0;
	...
	private String generateTableCode(List<DeletedGoods> data){
		...
		for(DeletedGoods datum:data){
			...
			returnValue=returnValue+"<tr>";
				...
				returnValue=returnValue+"<td>"+datum.getGoods().getInsurance().getName()+"</td>";
				returnValue=returnValue+"<td>"+datum.getQuantity()+"</td>";
				returnValue=returnValue+"<td>"+function.getTextManipulator().doubleToRupiah(datum.getPrice())+"</td>";
				returnValue=returnValue+"<td>"+function.getTextManipulator().doubleToRupiah((datum.getPrice()*datum.getQuantity()))+"</td>";
	...
	List<DeletedGoods> getDailyConsumption(DateTime startDate, DateTime endDate, boolean isAccepted){
