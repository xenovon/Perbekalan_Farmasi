...
public class ReportDailyConsumptionResultView extends VerticalLayout implements Button.ClickListener{
	...
	private ReportDailyConsumptionModel model;
	...
	public ReportDailyConsumptionResultView(GeneralFunction function) {
	...
	public void init(ReportData data, ReportContentListener listener) {
		...
		model=new ReportDailyConsumptionModel(function, data);
