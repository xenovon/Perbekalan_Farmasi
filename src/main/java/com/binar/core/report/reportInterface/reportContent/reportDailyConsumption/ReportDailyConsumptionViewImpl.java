...
public class ReportDailyConsumptionViewImpl extends VerticalLayout implements ClickListener, ValueChangeListener, ReportContentView {
	...
	public ReportData getReportData() {
		...
		data.setType(ReportType.DAILY_CONSUMPTION);
		return data;
	}
